...
public class DatabaseMetaDataTest {
    ...
    public void getAllTableList() {
        try {
            ...
            String[] types = {"TABLE"};
            ResultSet rs = dbMetaData.getTables(con.getCatalog(), "%", "%", types);
            while (rs.next()) {
    ...
    public void getTableColumns(String schemaName, String tableName) {
        ...
        try {
            ...
            ResultSet rs = dbMetaData.getColumns(con.getCatalog(), schemaName, tableName, "%");
            while (rs.next()) {
